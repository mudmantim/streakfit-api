...
INSIGHT_LIBRARY = [
    {'text': "A ten-minute walk lifts most people's mood, and it usually starts before the walk is over.",
     'category': 'MOVEMENT'},
    ...
    {'text': 'Playing tag or chasing a ball is a full workout disguised as a game.',
     'category': 'MOVEMENT'},
    {'text': 'Moving around in the morning wakes you up, and unlike a hot drink it works on the way to being useful.',
     'category': 'MOVEMENT'},
    ...
    {'text': "Spending time outside in daylight helps your body know when it's day and when it's night.",
     'category': 'HEALTH'},
    {'text': "Sore muscles after exercise mean they were asked to do something unfamiliar. It isn't injury, and it settles.",
     'category': 'RECOVERY'},
    ...
    {'text': "Most of your body's repair work happens while you're asleep.",
     'category': 'SLEEP'},
    {'text': "A consistent bedtime helps, because your body starts getting ready for sleep before you do — but it doesn't buy you fewer hours.",
     'category': 'SLEEP'},
    ...
    {'text': 'A little gentle stretching most days works better than one long stretch once a week.',
     'category': 'FLEXIBILITY'},
    {'text': "How flexible you feel shifts over the day, usually easing up by the afternoon. It's a small effect — a stiff morning means nothing.",
     'category': 'FLEXIBILITY'},
    ...
    {'text': "It's easier to build a new habit than to break an old one, so replacing beats removing.",
     'category': 'HABITS'},
    {'text': "A promise made to someone else is easier to keep than one made only to yourself — as long as it's a promise, not an announcement.",
     'category': 'HABITS'},
    ...
    {'text': 'Babies are born with more bones than adults — many of them fuse together as you grow.',
     'category': 'FUN FACTS'},
    {'text': 'Your jaw muscle can bite with a few hundred pounds of force — which is why people keep calling it the strongest muscle, though nobody agrees how to measure that.',
     'category': 'FUN FACTS'},
    ...
    {'text': 'Your tongue is actually made up of several muscles working together, not just one.',
     'category': 'FUN FACTS'},
    {'text': 'A sneeze leaves you at something like 10 to 20 miles an hour — much slower than the famous claim, and still faster than you can move your hand.',
     'category': 'FUN FACTS'},
    ...
    {'text': "It's almost impossible to tickle yourself the way someone else can tickle you.",
     'category': 'FUN FACTS'},
    {'text': 'For how light it is, bone stands up to squashing about as well as concrete. Pull on it instead and steel wins easily.',
     'category': 'FUN FACTS'},
    {'text': 'Humans are one of the few animals that can sweat over almost their entire body to cool down.',
     'category': 'FUN FACTS'},
    {'text': 'Over a lifetime, your heart moves enough blood to fill something like a hundred swimming pools.',
     'category': 'FUN FACTS'},
]
...
BRAIN_BOOST_LIBRARY = [
    {'question': 'About how long is a stretch usually held for?',
     'options': ['Around 20 to 30 seconds', 'Two seconds — a quick pull is all it takes',
                 'At least five minutes on each muscle', 'How long you hold it makes no difference'],
     'correct_index': 0,
     'explanation': ('Twenty to thirty seconds is the usual guidance: long enough for the muscle to'
                     " stop resisting and settle. Shorter holds aren't wasted, though — several short"
                     ' ones add up to much the same thing, so a quick stretch still counts.')},
    {'question': 'What causes the ache that shows up a day or two after exercise?',
     'options': ['Lactic acid left sitting in the muscle after the session',
                 'Unfamiliar work putting small amounts of stress through the fibers',
                 'Losing too much water while you were moving',
                 'A joint that has been pushed further than it should have been'],
     'correct_index': 1,
     'explanation': ("Work your muscles aren't used to — especially lowering things slowly — puts"
                     ' small amounts of stress through the fibers, and they rebuild a bit sturdier.'
                     " It isn't lactic acid: that clears within about an hour of stopping, long"
                     ' before the ache arrives. Ordinary soreness eases over a few days; sharp pain'
                     ' that sticks around is worth having someone look at.')},
    {'question': 'Which of these helps most people fall asleep faster?',
     'options': ['A slightly cooler room', 'A warm room, so your muscles stay relaxed',
                 'Bright light for the last hour before bed', 'A long nap in the late afternoon'],
     'correct_index': 0,
     'explanation': ('Falling asleep depends on your body shedding a little heat, and a cool room'
                     ' makes that easy. A warm room sounds relaxing but works against the drop in'
                     ' core temperature that sleep actually waits for.')},
    {'question': "What's a simple way to check your balance at home?",
     'options': ['Standing on one foot for a few seconds',
                 'Timing how fast you can get up the stairs',
                 'Sitting down and lifting both feet off the floor',
                 'Seeing how far you can reach while sitting still'],
     'correct_index': 0,
     'explanation': ('Standing on one foot makes your ankle, your eyes and your inner ear do work'
                     ' they normally share with the other leg, so any wobble shows up straight away.'
                     ' Next to a wall or a worktop is the sensible place to try it. Sitting tests'
                     ' take the one thing that matters — holding yourself up — out of the picture.')},
    {'question': 'Why does a short walk after a meal help?',
     'options': ['Your working muscles take up some of the sugar from the food',
                 'The movement jostles food through your system faster',
                 'Walking pulls blood away from digestion, so it slows things down',
                 "The effect only appears once you've walked for about an hour"],
     'correct_index': 0,
     'explanation': ("Muscles pull glucose out of the blood while they're working, so the rise after"
                     " a meal is gentler. Ten minutes is enough to measure — you don't need an hour."
                     " And walking doesn't steal blood from digestion: that's the opposite of what"
                     ' happens.')},
    {'question': 'What tends to happen to how flexible you feel across a day?',
     'options': ['Most people loosen up as the day goes on',
                 "You're at your stiffest in the middle of the afternoon",
                 "Flexibility is fixed — it doesn't shift hour to hour",
                 "You're loosest first thing, before you've moved much"],
     'correct_index': 0,
     'explanation': ('Range of movement tends to improve through the day, tracking body temperature,'
                     " which peaks in the late afternoon or early evening. It's a modest effect and"
                     " it varies between people — worth knowing mainly so a stiff morning doesn't get"
                     ' read as a bad sign.')},
    {'question': 'What makes a new habit most likely to stick?',
     'options': ['Tying it to something you already do every day',
                 'Starting as big as you can while motivation is high',
                 'Waiting until you can commit to doing it properly',
                 'Trusting yourself to remember it when a moment comes free'],
     'correct_index': 0,
     'explanation': ('A habit needs a cue, and the most reliable cue is something already nailed'
                     ' down in your day — after you brush your teeth, before you put the kettle on.'
                     ' Starting big is the common instinct and usually the first thing to collapse:'
                     ' the size you can repeat beats the size that impresses you.')},
    {'question': 'Roughly how big is an adult heart?',
     'options': ['About the size of a closed fist', 'About the size of a walnut in its shell',
                 'About the size of a football', 'About the size of a folded newspaper'],
     'correct_index': 0,
     'explanation': ("It's a fist-sized pump sitting slightly left of center behind your breastbone,"
                     ' and it gets through something like 100,000 beats a day without being asked.')},
    {'question': 'What usually happens after someone misses one day of a habit?',
     'options': ['Nothing much, as long as they pick it up again next time',
                 'The habit has to be rebuilt from the beginning',
                 'They need to do double the next day to stay even',
                 'The streak matters more than the habit underneath it'],
     'correct_index': 0,
     'explanation': ('One missed day barely registers. What ends habits is treating the miss as'
                     ' proof the whole thing has failed — the getting-back-to-it is the part that'
                     " matters, and it's available every single day.")},
    {'question': "What's unusual about climbing stairs, compared with walking on the flat?",
     'options': ['It asks your legs to lift your whole weight, step after step',
                 'It uses the same muscles but moves them through a smaller range',
                 'It works your calves and almost nothing else',
                 "It's gentler on the heart because you're going slower"],
     'correct_index': 0,
     'explanation': ('Every step up is a small one-legged lift of your entire body weight, which is'
                     ' why a flight of stairs leaves you breathing harder than the same distance on'
                     " the flat. It's also why stairs are one of the most useful things in an"
                     ' ordinary house.')},
    {'question': 'Where do children pick up most of their movement habits?',
     'options': ['From watching the adults around them',
                 'From being told regularly that exercise matters',
                 'Mostly from PE lessons at school',
                 'From whichever sport their friends happen to play'],
     'correct_index': 0,
     'explanation': ('Children copy what the adults around them actually do far more reliably than'
                     " they follow what they're told — which is inconvenient, and also the most"
                     ' useful lever any parent has.')},
    {'question': 'What improves balance fastest?',
     'options': ['Short goes at it, often', 'One long session every week or so',
                 'Staying off anything uneven until it improves',
                 'Practicing only with your eyes shut'],
     'correct_index': 0,
     'explanation': ('Balance is a skill your nervous system rehearses, and rehearsal likes'
                     ' frequency more than duration. A minute while the kettle boils, most days,'
                     ' beats half an hour on a Sunday.')},
    {'question': 'How does bone compare with steel?',
     'options': ['Bone resists squashing well for its weight; steel wins overall',
                 'Bone is stronger than steel by every measure anyone uses',
                 'Bone is weaker than steel by every measure anyone uses',
                 "They're close enough that bone has been used in engineering"],
     'correct_index': 0,
     'explanation': ('"Pound for pound, stronger than steel" is a half-truth. Bone does well on'
                     ' compression for how light it is, which is the comparison that factoid is'
                     ' quietly making. Pull on it rather than squash it, or compare the two outright,'
                     " and steel wins comfortably — bone's real trick is being strong enough while"
                     ' staying light enough to carry around.')},
    {'question': 'What does a short daytime nap tend to do?',
     'options': ['Sharpen focus for a few hours without much cost to that night',
                 'Take the edge off tiredness but leave you groggy for the rest of the day',
                 'Work only for young children, whose sleep is different',
                 'Do nothing useful unless it runs a couple of hours'],
     'correct_index': 0,
     'explanation': ('Ten to twenty minutes is the sweet spot: long enough to lift alertness, short'
                     " enough that you don't surface out of deep sleep feeling worse than you went"
                     ' in. The groggy-nap problem is a length problem, not a nap problem.')},
    {'question': 'Which of these is the ordinary kind of post-exercise soreness?',
     'options': ['A general achy tiredness that eases over a few days',
                 'A sharp pain that arrives suddenly during a movement',
                 'Swelling around a joint that keeps getting bigger',
                 'Not being able to put weight on something at all'],
     'correct_index': 0,
     'explanation': ('Dull, spread-out, and fading by itself is the normal kind. Sharp, sudden,'
                     " swelling, or something you can't use — those are your body asking for a"
                     ' different response, which is to stop and have someone take a look.')},
    {'question': 'Which part of a slow breath is the part that calms you down?',
     'options': ['Breathing out for longer than you breathe in',
                 'Filling your lungs as full as they will go',
                 'Holding the breath at the top for as long as you can',
                 'Breathing quickly so more oxygen reaches your brain'],
     'correct_index': 0,
     'explanation': ('Your heart speeds up slightly as you breathe in and slows as you breathe out,'
                     ' so a long, unhurried exhale is the bit that actually settles things.'
                     ' Breath-holding contests do the opposite, and are genuinely risky in water —'
                     " never a calming technique. You also aren't short of oxygen when you're"
                     " stressed, so breathing faster doesn't help."),
     'category': 'Mind & Wellness'},
    {'question': "What happens when someone puts a name to what they're feeling?",
     'options': ['The feeling usually gets a little easier to handle',
                 'It makes the feeling stronger by focusing on it',
                 "It only works for feelings you've had before",
                 'It replaces the feeling with a different one'],
     'correct_index': 0,
     'explanation': ('Putting a feeling into words — "I\'m frustrated", "I\'m nervous" — reliably'
                     " takes some of the heat out of it. It doesn't make the feeling worse by naming"
                     " it, which is the usual worry. It also doesn't make it vanish; it just turns"
                     ' something vague into something you can think about.'),
     'category': 'Mind & Wellness'},
    {'question': 'Why does a walk help when your head is full of the same thought going round?',
     'options': ["Moving and new scenery interrupt the loop it's running in",
                 'Walking burns off the energy the worry was feeding on',
                 'It tires you enough that the thought stops mattering much',
                 'Extra blood reaches your brain, which helps solve the problem'],
     'correct_index': 0,
     'explanation': ('Going round and round on the same thought is a loop, and loops are broken by'
                     ' interruption more than by effort. New things to look at and a body with'
                     " something to do give your attention somewhere else to be. It isn't about using"
                     ' up energy or wearing yourself out — a gentle ten minutes works as well as a'
                     ' hard hour.'),
     'category': 'Mind & Wellness'},
    {'question': "What does writing down what's on your mind tend to do?",
     'options': ['A sentence has to come out in order, so the tangle gets a shape',
                 'It solves the problem you were writing about, by thinking it through',
                 "It works only if you're certain nobody will ever read it",
                 'It works only for people who find writing comes easily'],
     'correct_index': 0,
     'explanation': ('A worry can sit in your head as one big shapeless thing. Writing forces it'
                     ' into one word after another, which is why people often find the tangle is'
                     " smaller than it felt. The writing doesn't have to be good, and it doesn't"
                     ' solve anything by itself — it just makes the thing a shape you can look at.'),
     'category': 'Mind & Wellness'},
    {'question': 'What is a "growth mindset"?',
     'options': ['Treating ability as something practice changes',
                 'Believing anyone can be excellent at anything, given enough want',
                 'Staying positive about a result however it actually went',
                 'Measuring your progress against people slightly ahead of you'],
     'correct_index': 0,
     'explanation': ("It's the belief that getting better is a thing you do, not a thing you are."
                     ' Worth being precise about, because it gets stretched into "you can be'
                     ' anything", which isn\'t the claim and isn\'t true. It\'s narrower and more useful'
                     ' than that: being bad at something today is information about today.'),
     'category': 'Mind & Wellness'},
    {'question': 'What are the nerves and the racing heart before something new actually for?',
     'options': ['Getting your body ready to do something that matters',
                 'Warning you that the thing is likely to go badly',
                 "A sign you haven't prepared enough for it",
                 "Something that goes away once you're properly good at things"],
     'correct_index': 0,
     'explanation': ('The pounding heart and the fizzy stomach are your body getting ready, and they'
                     ' look almost identical whether the thing ahead is frightening or exciting.'
                     " People who are very good at something still get them — they've mostly just"
                     ' stopped reading them as a warning.'),
     'category': 'Mind & Wellness'},
    {'question': 'What happens to concentration when you work at one thing for a long stretch?',
     'options': ['It drops off gradually, and a short break restores some of it',
                 "It holds steady as long as you're interested in the task",
                 'It improves the longer you stay with one thing',
                 'It only drops once you start to feel physically tired'],
     'correct_index': 0,
     'explanation': ('Attention on a single task decays — measurably, within tens of minutes — and'
                     ' it does it whether or not you notice or feel tired. A few minutes away'
                     " restores part of it. Breaks aren't time taken out of the work; they're part of"
                     ' how the work keeps being any good.'),
     'category': 'Mind & Wellness'},
    {'question': 'What makes a child most likely to keep moving as they get older?',
     'options': ['Having found something they actually enjoy doing',
                 'Being good at a sport early on', 'Being reminded often that exercise is important',
                 'Having started younger than everyone else'],
     'correct_index': 0,
     'explanation': ('Enjoyment predicts whether someone is still moving years later better than'
                     ' talent, early starts or encouragement do. Being good at something young is a'
                     ' weaker signal than people expect — plenty of early stars stop, and plenty of'
                     ' people who were never picked first are still walking, swimming and dancing at'
                     ' sixty.'),
     'category': 'Family & Together'},
    {'question': "What does cheering for someone do that comparing them to someone else doesn't?",
     'options': ['It keeps attention on what they did, not where they rank',
                 'It motivates them to try harder and win the next one',
                 'It works well with children but stops landing with adults',
                 'It stops them noticing when a day has genuinely gone badly'],
     'correct_index': 0,
     'explanation': ('Comparison quietly changes the subject from "did I move today" to "am I'
                     ' winning", and only one of those is a thing you can keep doing for life.'
                     ' Cheering keeps the subject where it started. It works on everyone, and it'
                     " doesn't require pretending a bad day was a good one."),
     'category': 'Family & Together'},
    {'question': 'Roughly how much of what children learn about being active comes from watching, rather than being told?',
     'options': ['Most of it', 'About half of it', 'Very little — instruction matters more',
                 "None — it's mainly decided by personality"],
     'correct_index': 0,
     'explanation': ('Children read behavior far more accurately than they absorb instruction, which'
                     " is why the walk you take on a day you don't feel like it does more than any"
                     " amount of explaining. Personality plays a part, but it isn't the main lever,"
                     ' and the main lever is one adults are holding already.'),
     'category': 'Family & Together'},
    {'question': 'Why can a nine-year-old and a sixty-year-old do the same walk together?',
     'options': ['Walking has no single right speed or distance, so both can be working',
                 "Because walking is easy enough that it doesn't count as exercise for either",
                 'Because children have much less stamina than adults',
                 "Because fitness stops mattering once you're past about fifty"],
     'correct_index': 0,
     'explanation': ('Effort is relative. The same walk can be gentle for one person and a genuine'
                     ' workout for another, and both get something from it. Children actually have'
                     ' plenty of stamina — what they have less of is the pacing to spend it evenly.'),
     'category': 'Family & Together'},
    {'question': 'Why do children sometimes get clumsier during a growth spurt?',
     'options': ["Their limbs got longer faster than the brain's map updated",
                 'Growing uses energy that would otherwise go to coordination',
                 'Bones grow before muscles do, which makes movement stiffer',
                 "Growing children lose balance practice while they're resting"],
     'correct_index': 0,
     'explanation': ('Your brain holds a map of how long your arms and legs are, built from'
                     ' practice. When the limbs get longer quickly, the map is briefly out of date'
                     ' and things get knocked over. It sorts itself out with ordinary use — the map'
                     ' updates by moving.'),
     'category': 'Growing & Ageing'},
    {'question': "Does lifting weights stunt a child's growth?",
     'options': ["No — it's an old myth, and sensible strength work is fine",
                 'Yes — it compresses the growth plates and costs final height',
                 'Yes, but only for children who start before about twelve',
                 'Nobody knows — it would be unethical to run the study'],
     'correct_index': 0,
     'explanation': ("This one has been studied a lot, and the height claim doesn't hold up. It"
                     ' probably came from confusing cause and effect — smaller children were once'
                     ' more likely to be put in weightlifting. What genuinely matters is how'
                     ' something is done: sensible loads and someone showing you how, the same as any'
                     ' other skill.'),
     'category': 'Growing & Ageing'},
    {'question': 'Why can children often play for hours without seeming to need a rest?',
     'options': ['They recover between bursts much faster than adults do',
                 'They have more stamina than adults overall',
                 "They don't notice tiredness until much later",
                 "Their muscles are more efficient than an adult's"],
     'correct_index': 0,
     'explanation': ('Children play in bursts rather than at a steady pace, and they bounce back'
                     " between bursts remarkably quickly. Their overall endurance isn't higher than a"
                     " fit adult's — the recovery is what's different, which is why the adult is the"
                     ' one asking to sit down.'),
     'category': 'Growing & Ageing'},
    {'question': 'What happens to balance as people get older, if nothing is done about it?',
     'options': ['It fades slowly, and practicing it slows the fade a great deal',
                 'It stays the same until quite late in life, then drops suddenly',
                 "It's fixed by your genes and can't be practiced",
                 'It improves, because of all the years of practice'],
     'correct_index': 0,
     'explanation': ('Balance behaves like any other skill: use keeps it, disuse loses it. The drift'
                     ' is gradual and it responds well to being practiced, which is why standing on'
                     ' one leg while the kettle boils is a genuinely useful minute at any age.'),
     'category': 'Growing & Ageing'},
    {'question': 'Why does the same hill get easier after a few weeks of walking it?',
     'options': ['Your heart pushes more blood per beat, so it costs less',
                 'Your lungs grow bigger and hold more air than they did',
                 'Your legs learn the route, so the same hill feels shorter',
                 'Your body adapts to need less oxygen than it used to'],
     'correct_index': 0,
     'explanation': ('The main change is in the pump: a fitter heart moves more blood with each'
                     " beat, so it doesn't have to beat as fast to do the same job. Lungs don't"
                     " change size much with training, and you don't need less oxygen — you just"
                     ' deliver it better.'),
     'category': 'Heart & Lungs'},
    {'question': 'What does a resting heart rate settling lower over months usually mean?',
     'options': ['The heart is doing the same work with fewer beats',
                 'The heart is getting weaker and beating less forcefully',
                 "There's less blood in circulation than there was",
                 "It's random, and doesn't track fitness at all"],
     'correct_index': 0,
     'explanation': ('Fewer beats for the same output is what getting fitter looks like from the'
                     " outside. It's one of the few changes you can actually watch happen — count for"
                     ' a minute now, and again in two months of regular walking.'),
     'category': 'Heart & Lungs'},
    {'question': "What's the simplest way to tell whether you're working at an easy pace?",
     'options': ['You can hold a conversation, but not comfortably sing',
                 "You've not started sweating yet, whatever the pace feels like",
                 'Your heart rate is somewhere under about 120 beats',
                 'You could keep the same pace up for at least an hour'],
     'correct_index': 0,
     'explanation': ('The talk test costs nothing and needs no watch: speaking in sentences means'
                     ' steady, singing means easy, and struggling for words means hard. Sweating'
                     ' depends mostly on the weather, and a single heart-rate number fits almost'
                     ' nobody.'),
     'category': 'Heart & Lungs'},
    {'question': 'Which kind of ache is worth stopping for?',
     'options': ['A sharp pain in one specific spot, especially in a joint',
                 "A general heaviness in the muscles you've been using",
                 'Being out of breath more than you expected',
                 'Feeling wobbly-legged for a few minutes afterwards'],
     'correct_index': 0,
     'explanation': ('Spread-out, dull and fading is the ordinary kind. Sharp, pinpointed, and'
                     ' coming from a joint is the kind that wants attention now rather than tomorrow.'
                     ' Being out of breath or briefly wobbly is just effort, and it passes.'),
     'category': 'Safety & Sense'},
    {'question': "Something still hurts the next morning. What's the sensible move?",
     'options': ['Do something gentler today and see how it is tomorrow',
                 'Push through it, because stopping loses your progress',
                 "Rest completely until there's no feeling at all",
                 'Repeat exactly what caused it, so the body adapts'],
     'correct_index': 0,
     'explanation': ('Gentler, not nothing, and check again tomorrow. Complete rest is rarely needed'
                     ' and often slows things down, and doing exactly the thing that hurt is how a'
                     " small niggle becomes a long one. If it's still there in a few days, or getting"
                     " worse, that's the point to ask someone who can look at it."),
     'category': 'Safety & Sense'},
    {'question': "What's the most useful thing to do before moving about in hot weather?",
     'options': ["Drink before you're thirsty and plan somewhere shaded to stop",
                 'Wear more layers so you sweat the heat out faster',
                 "Skip drinking during, so you aren't sloshing about",
                 'Go harder than usual, since the heat has warmed you up already'],
     'correct_index': 0,
     'explanation': ("Thirst lags behind what you've actually lost, so drinking early is the useful"
                     ' habit. Extra layers trap the heat your body is trying to shed, which is the'
                     " opposite of helping. And heat makes everything cost more, so it's a day to do"
                     ' less, not more.'),
     'category': 'Safety & Sense'},
    {'question': 'Why is jumping into cold water risky even for a strong swimmer?',
     'options': ['Cold water makes you gasp, which is the danger below the surface',
                 'Cold muscles cramp the moment they hit the water',
                 "Cold water is denser, so it's much harder to stay afloat",
                 'The danger builds with how long you stay in, not on entry'],
     'correct_index': 0,
     'explanation': ('The first thing cold water does is make you gasp and breathe fast, whether you'
                     ' want to or not, and a gasp underwater is the actual danger — not the'
                     ' temperature or how long you stay. Getting in slowly gives that reflex a minute'
                     ' to settle.'),
     'category': 'Safety & Sense'},
    {'question': "A movement doesn't work for your body today. What's the best response?",
     'options': ['Do a smaller version, or something that asks the same of you',
                 "Skip the session, since a partial one doesn't really count",
                 "Do it anyway, and accept that it won't be comfortable",
                 'Wait until whatever is limiting you has cleared up properly'],
     'correct_index': 0,
     'explanation': ('Almost every movement has a smaller cousin: a squat to a chair, a push-up'
                     ' against a wall, a march instead of a jump. The smaller version is not a lesser'
                     " session — it's the same session, sized for the day you're actually having."),
     'category': 'Safety & Sense'},
    {'question': 'What does a wall push-up have in common with a floor push-up?',
     'options': ['The same muscles in the same pattern, with less of your weight on them',
                 "Nothing — it's a different movement that happens to look similar",
                 "It's harder, because your feet have less grip",
                 'It only helps as practice for the real one'],
     'correct_index': 0,
     'explanation': ("Standing further from the wall puts more of you into it, so it's one movement"
                     " with a dial on it rather than a beginner's substitute. That's true of most"
                     ' things: the angle, the range, or how much of you is involved is usually the'
                     ' adjustable part.'),
     'category': 'Safety & Sense'},
    {'question': 'What helps most if you have to sit for most of the day?',
     'options': ['Getting up briefly and often, rather than one long session later',
                 'One hard workout at the end of the day',
                 'Sitting up straighter for the whole time',
                 "Nothing much — sitting is unavoidable, so it can't be helped"],
     'correct_index': 0,
     'explanation': ('Breaking up the sitting matters somewhat separately from how much you'
                     ' exercise: standing up every half hour or so does something a single evening'
                     " session doesn't replace. Posture helps comfort, but it's the getting up that"
                     ' shows in the measurements.'),
     'category': 'Everyday Movement'},
    {'question': 'Why do your eyes feel tired after a long stretch of screen time?',
     'options': ['Close focus holds one muscle still, and you blink less often',
                 "Screens emit a kind of light your eyes can't process well",
                 'Your eyes work harder at a screen than they do outdoors',
                 'The brightness slowly wears away the surface of the eye'],
     'correct_index': 0,
     'explanation': ('Close focus is a held position, like any other held position, and people blink'
                     ' roughly half as often while reading a screen — which is why eyes feel dry as'
                     ' well as tired. Looking at something far away for a few seconds lets the muscle'
                     " let go. The screen isn't damaging anything."),
     'category': 'Everyday Movement'},
    {'question': 'Why is catching a ball harder than it looks?',
     'options': ['Your brain predicts where it will be, rather than reacting',
                 'The ball moves faster than your eyes are able to track it',
                 'Your hands respond more slowly than the rest of your body',
                 'It depends mostly on how strong and quick your grip is'],
     'correct_index': 0,
     'explanation': ('Nerve signals take time, so reacting to where the ball is would always be too'
                     ' late. Your brain is running a prediction and putting your hand where the ball'
                     ' is going to be. Practice mostly improves the prediction, which is why catching'
                     ' gets easier without your hands getting any faster.'),
     'category': 'Brain & Movement'},
    {'question': 'What happens when you learn a physical skill well enough to stop thinking about it?',
     'options': ["Control shifts to parts of the brain you needn't attend to",
                 'The movement gets stored in the muscles that perform it',
                 'Your brain hands it to the spinal cord and stops tracking it',
                 "You've reached the point where it can no longer improve"],
     'correct_index': 0,
     'explanation': ('"Muscle memory" is a good name for a real thing in the wrong place — muscles'
                     ' store nothing. What happens is that control moves to circuits that run without'
                     ' your attention, which is why you can hold a conversation while cycling, and'
                     ' why thinking too hard about it makes you wobble.'),
     'category': 'Brain & Movement'},
]
